...
class TaintedVariables(object):
    ...
    def get_permissions_method(self, method):
        ...
        for f, f1 in self.get_fields():
            ...
            if self.API_PERMISSION_MAPPINGS_MODULE and self.API_PERMISSION_MAPPINGS_MODULE['AOSP_PERMISSIONS_BY_FIELDS'] and data in self.API_PERMISSION_MAPPINGS_MODULE['AOSP_PERMISSIONS_BY_FIELDS'].keys():
            ...
            for j in paths:
                if j.get_method() == method:
                    if j.get_access_flag() == TAINTED_PACKAGE_CALL:
                        ...
                        if self.API_PERMISSION_MAPPINGS_MODULE and self.API_PERMISSION_MAPPINGS_MODULE['AOSP_PERMISSIONS_BY_METHODS'] and data in self.API_PERMISSION_MAPPINGS_MODULE['AOSP_PERMISSIONS_BY_METHODS'].keys():
